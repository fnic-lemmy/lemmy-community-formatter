...
title = title.Trim('-');
title = title.Trim();
var markdown = $"**[{title}](/c/{communityName}@{serverHost})** | {serverHost} | [Mbin](/m/{communityName}@{serverHost}) | [lemmyverse.link](https://lemmyverse.link/c/{communityName}@{serverHost}) | ![](https://img.shields.io/lemmy/{communityName}@{serverHost}?style=flat&label=Subs&cacheSeconds=172800&color=pink)";
